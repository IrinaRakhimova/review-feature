...
export default function SuccessModal({ openModal, onClose, addReview, reviews }) {
  ...
  return (
    ...
    >
      ...
      (<Box sx={style}>
        ...
        <Typography gutterBottom>Your feedback is successfully submitted.</Typography>
      ...
      >
        ...
        <div className="specialistInfo">
              <RatingInfo reviews={reviews} /></div>
              <form
